        ...
        text-white flex items-center justify-center p-4'>
            <div className='w-full max-w-md'>
                ...
                <div className='rounded-lg h-96 flex items-center justify-center relative'
                    ...
                    {mode === 'text' && (
                        <textarea placeholder="What's on your mind?"
                            onChange={(e) => setText(e.target.value)} value={text} className='bg-transparent text-white
                        w-full h-full p-6 text-lg resize-none focus:outline-none' />
                    )}
                    {
                ...
                <div className='flex gap-2 mt-4'>
                    ...
                    gap-2 p-2 rounded cursor-pointer 
