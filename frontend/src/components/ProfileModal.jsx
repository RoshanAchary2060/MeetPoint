...
const ProfileModal = ({ setShowEdit }) => {
    ...
    return <div className='fixed top-0 left-0 bottom-0 right-0 z-110 h-screen
                ...
                <form className='space-y-4' onSubmit={handleSaveProfile} action="">
                    ...
                    <div className='flex flex-col items-start gap-3'>
                        <label htmlFor="profile_picture"
                            className='block text-sm font-medium text-gray-700 mb-1'> Profile Picture
                            <input hidden type="file" accept='image/*' name="" id="profile_picture"
                    ...
                    <div className='flex flex-col items-start gap-3'>
                        <label htmlFor="cover_photo"
                            ...
                            Cover Photo
                            <input hidden type="file" accept='image/*' name="" id="cover_photo"
                            ...
                            <div className='group/cover relative'>
                                ...
                                right-0 bottom-0 bg-black/20 rounded-lg items-center justify-center'>
                                    <Pencil className='w-5 h-5 text-white' />
                                </div>
                            </div>
                        </label>
                    ...
                    <div>
                        ...
                        rounded-lg' placeholder='Please enter your full name'
                            ...
                            value={editForm.full_name} name="" id="" />
                    </div>
                    <div>
                        <label className='block text-sm font-medium text-gray-700 mb-1'>
                            Username
                        ...
                        <input type="text" className='w-full p-3 border border-gray-200
                        rounded-lg' placeholder='Please enter your username'
                            onChange={(e) => setEditForm({ ...editForm, username: e.target.value })}
                            value={editForm.username} name="" id="" />
                    </div>
                    <div>
                        <label className='block text-sm font-medium text-gray-700 mb-1'>
                            Bio
                        ...
                        rounded-lg' placeholder='Please enter a short bio'
                            onChange={(e) => setEditForm({ ...editForm, bio: e.target.value })}
                            value={editForm.bio} name="" id="" />
                    </div>
                    <div>
                        <label className='block text-sm font-medium text-gray-700 mb-1'>
                            Location
                    ...
                    <div className='flex justify-end space-x-3 pt-6'>
                        <button type='button' onClick={() => setShowEdit(false)} className='px-4 py-2 border border-gray-300 rounded-lg text-gray-700
