    ...
    return (
        ...
        flex items-center justify-center' style={{
            ...
            sm:p-4 sm:px-8 backdrop-blur-2xl rounded bg-black/50'>
                <img className='size-7 sm:size-8 rounded-full object-cover
                border border-white' src={viewStory.user?.profile_picture} />
            ...
            {/* Close Button */}
            <button onClick={handleClose} className='absolute top-4 right-4 text-white text-3xl font-bold
            focus:outline-none'>
