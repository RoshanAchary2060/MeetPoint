    ...
    return (
        <div className='relative py-4 px-6 md:px-8 bg-white'>
            <div className='flex flex-col md:flex-row items-start gap-6'>
              <div className="absolute -top-16 left-8 w-32 h-32 rounded-full overflow-hidden border-4 border-white shadow-lg bg-white">
                <img
                ...
                <div className='w-full pt-15 md:pt-0 md:pl-36'>
                    <div className='flex flex-col md:flex-row items-start justify-between'>
                        ...
                        {
                            !profileId && <button onClick={() => setShowEdit(true)} className='flex items-center gap-2 border
                            broder-gray-300 hover:bg-gray-50 px-4 py-3 rounded-lg
