    ...
    return (
        ...
        border border-gray-200 rounded-md'>
            <div className='text-center'>
                ...
                {user.username && <p className='text-gray-500 font-light'>
                    @{user.username}</p>}
                {user.bio && <p className='text-gray-600 mt-2 text-center text-sm'>
                    {user.bio}
                </p>}
            ...
            <div className='flex mt-4 gap-2'>
                ...
                <button onClick={handleConnectionRequest} className='flex items-center justify-center w-16 border text-slate-500
